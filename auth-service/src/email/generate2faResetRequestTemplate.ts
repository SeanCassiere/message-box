export function generate2faResetRequestTemplate({ token, host, path }: { token: string; host: string; path: string }) {
  const body = `
			...
			<table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
				<tbody>
					<tr>
						...
						<h2 style="color: #000; font-size: 34px; margin-bottom: 0; font-weight: 500; line-height: 1.4">Reset your password.</h2>
						</div>
						</td>
					</tr>
					<tr>
